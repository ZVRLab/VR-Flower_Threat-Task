...
public class SceneLoader : MonoBehaviour
{
    ...
    public static bool needsAcclimation;
...
{
    // Only these scenes go through acclimation
    if (sceneName == "PlatformTask" || sceneName == "CrossingTask")
    {
        SceneLoader.nextScene = sceneName;
        SceneLoader.needsAcclimation = true;

        SceneManager.LoadScene("Acclimation");
    }
    else
    {
        SceneLoader.needsAcclimation = false;
